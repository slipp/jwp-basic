    ...
    <div class="col-md-12">
        <div class="navbar-header">
            ...
            <ul class="nav dropdown-menu">
                <li><a href="../users/profile.html"><i class="glyphicon glyphicon-user" style="color:#1111dd;"></i> Profile</a></li>
            ...
            <table class="table table-hover">
                ...
                <c:forEach items="${users}" var="user" varStatus="status">
                    <tr>
                        ...
                        <td>${user.name}</td>
                        <td>${user.email}</td>
                        <td><a href="/users/update.jsp" class="btn btn-success" role="button">수정</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
